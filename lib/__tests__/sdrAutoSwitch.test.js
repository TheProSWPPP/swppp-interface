...
describe("classifyHop", () => {
  ...
  it("falls back to the old suppress-entirely behaviour when no award sequence is configured", () => {
...
describe("awardOnlySequenceId", () => {
  it("is null until configured, which keeps the feature off by default", () => {

...
function classifyInbound(from, subject, snippet) {
  ...
  if (/automatic reply|auto[- ]?reply|out of (the )?office|on vacation|away from (my|the) (desk|office)/i.test(s)) return "auto";
  return null;
}
